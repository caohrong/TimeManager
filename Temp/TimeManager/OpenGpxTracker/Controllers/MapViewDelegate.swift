...
class MapViewDelegate: NSObject, MKMapViewDelegate, UIAlertViewDelegate {
    ...
    func mapView(_: MKMapView, annotationView view: MKAnnotationView,
                 didChange newState: MKAnnotationView.DragState, fromOldState _: MKAnnotationView.DragState)
    {
...
//            if !mapView.visibleMapRect.MKMapRectContainsPoint(point) { continue }
            ...
            UIView.animate(withDuration: 0.5, delay: interval, options: UIView.AnimationOptions.curveLinear, animations: { () in
    ...
    ///
    func addHeadingView(toAnnotationView _: MKAnnotationView) {}
}
